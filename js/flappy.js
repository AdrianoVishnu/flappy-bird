...
function Passaro(alturaDoJogo) {
    ...
    window.onkeypress = e => voando = true;
    window.onkeyup = e => voando = false;

    this.animar = () => {
        const novoY = this.getX() + (voando ? 8 : -5);
    ...
    this.start = () => {
        ...
        const temporizador = setInterval( () =>{
            ...
            if(colidiu(passaro, barreiras)) {
                ...
                box.innerHTML = `Voce fez <br> ${pontos} ${pontuacao} <br><br> <button onclick='location.reload();'>Jogar de novo</button>`;
            }
        }, 20 )
    }
}
